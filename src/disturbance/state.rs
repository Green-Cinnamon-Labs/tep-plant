/* tep/disturbance/state.rs */

use monjolo::disturbance::cubic::{CubicDisturbanceState, DisturbanceChannel};

/** TEP-specific disturbance state.

Wraps `CubicDisturbanceState` and initializes the 12 disturbance channels with the shape
parameters hardcoded in TEINIT from teprob.f.
...
impl TepDisturbanceState {
    ...
    */
    pub fn new() -> Self {
        /* Parameters from TEINIT in teprob.f — (h_span, h_zero, s_span, s_zero, sp_span) */
