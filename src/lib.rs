...
Organização de pastas: subsystems/ (os 7 blocos químicos + actuators.rs, 12 funções — uma por
atuador — que constroem instâncias de `monjolo::actuator::model::Actuator`, sem `struct` própria),
